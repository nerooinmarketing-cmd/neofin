...
export default async function BankDetailPage({
  ...
  const [bank, stats, posWithStats, tariffVersions] = await Promise.all([
        ...
        <TabsContent value="poslar" className="space-y-4">
          <div className="flex justify-end">
            <Button asChild size="lg">
              <Link href={`/bankalar/${bank.id}/pos/yeni`}>
          ...
          {posWithStats.length === 0 ? (
            <EmptyState
              ...
              action={
                <Button asChild size="lg">
                  <Link href={`/bankalar/${bank.id}/pos/yeni`}>POS Ekle</Link>
                </Button>
              }
            />
          ) : (
            <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
              {posWithStats.map(({ pos, stats: posStats }) => (
                <PosCard
                  ...
                  addTariffHref={`/bankalar/${bank.id}/pos/${pos.id}/tarife/yeni`}
                />
              ))}
            </div>
          )}
              ...
              >
                ...
                <div className="flex items-center gap-2">
                  ...
                  <Button asChild size="sm" variant="outline">
                    <Link href={`/bankalar/${bank.id}/pos/${tariff.posId}/tarife/yeni`}>
                      Yeni Sürüm
                    </Link>
                  </Button>
                </div>
